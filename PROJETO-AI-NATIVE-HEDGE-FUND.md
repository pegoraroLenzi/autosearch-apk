...
**Conta de viabilidade do teto (hipóteses registradas, a confirmar em produção):** ~45 entidades monitoradas (15–20 empresas + peers adaptados + âncoras); classificador de relevância em modelo econômico (classe Haiku) processando ~2.000 documentos/dia via batch ≈ US$ 2/dia; análise profunda com **cadência adaptativa** — só empresas com evento relevante ou na cadência mínima do livro, ~10 análises/dia × 6 agentes em modelo intermediário com a Base Fixa em prompt cache (§4.7) ≈ US$ 5–6/dia; comitê/debate para 2–3 ativos/dia ≈ US$ 2/dia. Total ≈ US$ 9–10/dia útil ≈ **R$ 1.100–1.400/mês sem otimização, R$ 600–900 com batch API** — o teto fecha, com margem apertada: batch + cache não são otimização opcional, são requisito de projeto; estouro sustentado do teto reduz cadência (não qualidade por análise) e sobe ao gestor no relatório mensal.
